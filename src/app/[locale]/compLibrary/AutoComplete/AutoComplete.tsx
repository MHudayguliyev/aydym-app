...
// icons 
import chevron from '@app/_assets/icons/chevron_right.svg'
...
type SearchValue = {
   label: string,
   value: string | number 
   flag?: StaticImageData | string | undefined
}
               ...
               {filteredSuggestions.map((suggestion, index) => {
                  ...
                  return (
                     <li className={className} key={index} onClick={(e) => onClick(e, index)}>
                        <Image src={suggestion?.flag ?? ""} alt="flag"/>
      ...
      return (
         <div className={
            ...
            <Input
               ...
               leftIcon={suggestions[activeSuggestionIndex]?.flag}
               rightIcon={chevron}
               className={className}
               roundedSm={rounded}
            />
